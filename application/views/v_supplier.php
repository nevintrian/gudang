                                        ...
                                        <tbody>
                                            ...
                                            foreach ($supplier_data as $supplier) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#" class="btn btn-primary btn-view" data-id="<?= $supplier->id; ?>" data-nama="<?= $supplier->nama; ?>" data-alamat="<?= $supplier->alamat; ?>"><i class="fa fa-eye"></i></a>
                                                        <a href="#" class="btn btn-info btn-edit" data-id="<?= $supplier->id; ?>" data-nama="<?= $supplier->nama; ?>" data-alamat="<?= $supplier->alamat; ?>"><i class="fa fa-marker"></i></a>
                                                        <a href="#" class="btn btn-danger btn-delete" data-id="<?= $supplier->id; ?>"><i class="fa fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                            <?php
                                                $i++;
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label>Nama supplier</label>
                        <input type="text" class="form-control nama" name="nama" placeholder="Nama Supplier">
                    </div>
                    <div class="form-group">
                        <label>Alamat</label>
